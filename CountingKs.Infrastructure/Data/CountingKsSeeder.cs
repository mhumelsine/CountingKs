namespace CountingKs.Infrastructure.Data
{
    ...
    public class CountingKsSeeder
    {
      ...
      ExecuteQueries(
        ...
        {
            SqlConnection conn = new SqlConnection(@"Data Source=(localdb)\mssqllocaldb;Initial Catalog=CountingKs;Integrated Security=True");
            conn.Open();

            SqlCommand cmd = new SqlCommand("SELECT * FROM ABBREV22", conn);
